...
Ahk2Exe.exe /in "SteamworksExample.ahk" || set message=Maybe u haven't the Compiler, maybe incorrect path, idk. Think about it. && call :messagebox && del /f /q "SteamworksExample.ahk" && exit
