...
Compiler\Ahk2Exe.exe /in "SteamworksExample.ahk" || set message=Maybe u haven't the Compiler, maybe you pressed 'No' in Compiler, idk. Try again. && call :messagebox && del /f /q "SteamworksExample.ahk" && exit
...
:short
	...
	echo oLink.TargetPath = "%~dp0SteamHack3.exe" >> shortcut2.vbs
